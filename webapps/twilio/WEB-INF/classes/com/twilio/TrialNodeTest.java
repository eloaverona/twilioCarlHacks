...
public class TrialNodeTest {
    ...
    public TrialNodeTest(){
        ...
        // Have Proofread up to here so far. 
        ...
        Node node82 = new Node(82, "You get caught in the calf with a tusk but not without repaying the boar in full. You thrust the rusty knife deep into it�s snout. While the boar is doubled over in pain you limp over to the double doors. a: Walk through the door.");
        ...
        Node node83 = new Node(83, "You try and run but the boar is so much faster, his tusk still manages to catch both of your legs. You can�t run, you can�t dodge, you cannot even stand up. You are demon pig chow. You die.");
